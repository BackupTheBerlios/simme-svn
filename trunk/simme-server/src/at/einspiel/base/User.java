...
public class User implements Comparable, Serializable {
    ...
    * @param winmessage Win message, written after game ending in success for
    *         user.
    ...
    *
    * @throws UserException if user could not be deleted.
    */
    ...
    * @throws UserException if user could not be inserted.
    */
