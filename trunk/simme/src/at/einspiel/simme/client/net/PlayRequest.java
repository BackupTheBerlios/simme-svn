...
/**
 * <p>This request is used to transfer move information from the client to the
 * server. It contains two internal request classes that handle information
 * transfer. They inherit from {@link at.einspiel.messaging.Request}.</p>
 * 
 * <p>A single play request should be created for one game. All local and remote
...
public class PlayRequest {
    ...
    /**
     * <p>Returns the last move from the server performed by the other player.
     * Additionally the message field may be set with an optional information
     * message.</p>
     * 
     * <p>If the move cannot be received within a specified timeout, the request
     * will be resent after a short break.</p>
     *  
