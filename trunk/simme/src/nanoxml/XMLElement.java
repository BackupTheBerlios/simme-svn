...
public class XMLElement
{
  ...
  public boolean getBooleanAttribute(String name, String trueValue,
    String falseValue, boolean defaultValue) throws XMLParseException
  {
    if (this.ignoreCase)
    {
      name = name.toUpperCase();
   ...
   * @param defaultValue Value to use if the attribute is missing.
   * @return see {@link #getBooleanAttribute(String, String, String, boolean)}.
   */
  public boolean getBooleanAttribute(String name, boolean defaultValue)
  {
    return getBooleanAttribute(name, "1", "0", defaultValue);
  }
   ...
   * @param name Name of the attribute.
   *
   * @return see {@link #getBooleanAttribute(String, boolean)}.
   */
