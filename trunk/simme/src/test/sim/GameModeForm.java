      ...
      case 0: // Internet Spiel
        ...
        try
        {
          ...
          if (prefs.currentSize() == 0)
          {
            ...
            buf.append("Nickname und Password m?ssen eingegeben ");
            buf.append("werden. Gehen Sie bitte hierf?r auf ");
            buf.append("\"Einstellungen|Internet\" im Hauptmen?.");
      ...
      Thread t = new Thread()
        {
          ...
          public void run()
          {
            try
            {
              ...
              try
              {
                loginMsg = new LoginMessage(loginData[0], loginData[1],
                    loginData[3], version);
              }
              ...
              else
              {
                ...
                AlertType type = result.isSucceed() ? AlertType.INFO
                                                    : AlertType.ERROR;
                Alert loginAlert = new Alert("Fehler bei Login",
                    result.getMessage(), null, type);
            ...
            catch (IOException ioex)
            {
              ...
              Alert errorAlert = new Alert("Fehler", errorMsg, null,
                  AlertType.ERROR);
