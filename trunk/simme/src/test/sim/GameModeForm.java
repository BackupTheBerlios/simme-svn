            ...
            case 0 : // Internet Spiel
               ...
               try {
                  ...
                  if (prefs.currentSize() == 0) {
                     ...
                     buf.append("Nick name and password have to be entered. Please set ");
                  ...
                  Alert error = new Alert("Fehler", pex.getMessage(), null, AlertType.ERROR);
         ...
         Thread t = new Thread() {
            ...
            public void run() {
               try {
                  ...
                  try {
                     loginMsg =
                        new LoginMessage(loginData[0], loginData[1], loginData[3], version);
                  ...
                  if (result.isSucceed()) {
                     ...
                     Alert loginAlert =
                        new Alert("Error while logging in", result.getMessage(), null, type);
