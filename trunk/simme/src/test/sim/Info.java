...
public class Info
{
  ...
  static
  {
    ...
    BUF.append("verbunden ist. Der Spieler der an der Reihe ist w?hlt ");
    BUF.append("eine Verbindung zwischen 2 Knoten aus. Diese wird dann in ");
    BUF.append("seiner Farbe angezeigt. Dann w?hlt der 2. Spieler eine ");
    ...
    BUF.append("formen und den Gegenspieler zum \"dreiecken\" zu dr?ngen.");
    BUF.append("\n\n");
    BUF.append("Um eine Verbindung auszuw?hlen, dr?ckt man auf eine ");
    ...
    BUF.append("Mit der Taste 0 ist jederzeit ein Undo m?glich!\n\n");
