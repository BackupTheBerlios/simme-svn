...
public class DrawUtils
{
   ...
   */
  public static void drawLine(Graphics g, int xStart, int yStart, int xEnd,
    int yEnd, int thickness)
  {
    if (thickness < 2)
    {
      return;
   ...
   */
  public static void drawLineWithBorder(Graphics g, int xStart, int yStart,
    int xEnd, int yEnd, int thickness, int innerColor, int outerColor,
    boolean dotted)
  {
    if (thickness < 2)
    {
  ...
  /**
   * Fills an arc and draws a border on the outside
   *
   * @param g Graphics context on which to draw.
   ...
   */
  public static void fillArcWithBorder(Graphics g, int x, int y, int width,
    int height, int startAngle, int arcAngle, int innerColor, int outerColor)
  {
    g.setColor(outerColor);
   ...
   * otherwise.
   */
  private static boolean drawAxisLine(Graphics g, int x1, int y1, int x2,
   ...
   * @param anchor ...
   */
  public static void drawStringWithBorder(Graphics g, String str, int x, int y,
    int anchor)
  {
