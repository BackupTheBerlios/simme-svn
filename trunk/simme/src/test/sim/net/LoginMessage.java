...
public class LoginMessage extends Request
{
   ...
   */
  public LoginMessage(String nick, String pwd, String clientmodel,
   ...
   *     </pre>
   */
  public static String makeLoginMessage(String nick, String pwd,
    String clientmodel, String version)
  {
