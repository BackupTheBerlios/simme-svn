...
public class PrefForm extends List implements CommandListener
{
  ...
  private Screen makePersPrefs()
  {
    ...
    final TextField tfNick = new TextField("Nick Name: ", data[0], 10,
        TextField.ANY);
    final TextField tfPass = new TextField("Passwort: ", data[1], 10,
        TextField.ANY);
    final TextField tfInfo = new TextField("Info (optional): ", data[2], 40,
        TextField.ANY);
    ...
    frmPrefs.append(new StringItem("Version: ",
        Sim.getProperty("MIDlet-Version")));
    ...
    frmPrefs.setCommandListener(new CommandListener()
      {
        public void commandAction(Command c, Displayable d)
        {
          if (c.getCommandType() == Command.BACK)
          {
            String[] newData = 
            {
              tfNick.getString(), tfPass.getString(), tfInfo.getString(),
              siPlatform.getText()
            };
