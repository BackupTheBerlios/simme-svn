...
class Zeichenblatt extends Canvas implements CommandListener {
  ...
  static final String[] nodeLabels = { "1", "2", "3", "4", "5", "6" };
  ...
  protected void paint(Graphics g) {
    ...
    graphics.setColor(p1c1);
    DrawUtils.drawLine(g, xPInfo1, yPInfo1middle, xPInfo2, yPInfo1middle, linewidththick);
    graphics.setColor(p2c1);
    DrawUtils.drawLine(g, xPInfo1, yPInfo2middle, xPInfo2, yPInfo2middle, linewidththick);
    
    // Spielernamen zeichnen
    graphics.setColor(0);
    graphics.drawString(game.getP1Name(), xPInfo3, yPInfo1 + linewidththick / 2, 0);
    graphics.drawString(game.getP2Name(), xPInfo3, yPInfo2 + linewidththick / 2, 0);
  ...
  /* private void drawWinner(Graphics g) {
     ...
     graphics.drawString("WINNER", xPInfo1 + 2, yPInfo1 + linewidththick / 2, 0);
     graphics.drawString("LOSER", xPInfo1 + 2, yPInfo2 + linewidththick / 2, 0);
     } else if (game.getWinner() == Game.PLAYER2) {
     graphics.drawString("LOSER", xPInfo1 + 2, yPInfo1 + linewidththick / 2, 0);
     graphics.drawString("WINNER", xPInfo1 + 2, yPInfo2 + linewidththick / 2, 0);
     }
     } */
