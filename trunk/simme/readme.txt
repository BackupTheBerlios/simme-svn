...
The binary release consists of four files. One set of two files is intended for
debugging, which is indicated by "-debug" in the file name. The other two files
(SimME.jar and SimME.jad) may be used to install the software on a real device
instead of just running it in the emulator.
