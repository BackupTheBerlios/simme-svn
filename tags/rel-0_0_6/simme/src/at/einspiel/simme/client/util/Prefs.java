...
public class Prefs {
	 ...
	 *             The "open" command cannot be successfully executed, if one of
	 ...
	 * 
	 * @throws PrefsException
	 *             The "close" command cannot be successfully executed, if one
	...
	/**
	 * Returns the current size of the record that is in use. It shows the
	 * number of records.
	 * 
	 * @return The number of records.
	 * 
	 * @throws PrefsException
	 *             if the RecordSet is not open.
	 */
	 ...
	 * 
	 * @throws PrefsException
	 *             see {@link RecordEnumeration#nextRecord()}
	 */
	 ...
	 * 
	 * @throws PrefsException
	 *             see {@link RecordStore#setRecord(int, byte[], int, int)}.
	 */
	 ...
	 * 
	 * @param b
	 *            the record to add as byte[].
	 * 
	 * @throws PrefsException
	 *             {@link RecordStore#addRecord(byte[], int, int)}
	 */
